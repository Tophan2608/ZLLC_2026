...
public:
    ...
    inline void Set_Drvier_Angle(float __Drvier_Angle);
...
protected:
    ...
    //拨弹盘堵转扭矩阈值, 超出被认为卡弹
    uint16_t Driver_Torque_Threshold = 7000;
    ...
    float Default_Driver_Omega = 2.0f * PI * 20.0f / 9.0f;
    uint8_t Drvier_Angle_Complete = 0;
    ...
    //摩擦轮角速度
    float Friction_Omega = 635.0f;//640.0f;
...
inline void Class_Booster::Set_Drvier_Angle(float __Drvier_Angle)
{
    Drvier_Angle = __Drvier_Angle;
}
