...
Class_Gimbal_Pitch_Motor_J4310 DM4310_test;
...
void Gimbal_Device_CAN1_Callback(Struct_CAN_Rx_Buffer *CAN_RxMessage)
{
    ...
    case (0x01):
    {
//		DM4310_test.CAN_RxCpltCallback(CAN_RxMessage->Data);
...
//		DM4310_test.TIM_PID_PeriodElapsedCallback();
...
//        DM4310_test.PID_Angle.Init(0.8f, 0.13f, 0.001f, 0.0f, 1.0f, 4.0f);
//		DM4310_test.PID_Omega.Init(1.1f, 0.1f, 0.0f, 0, 0.5f, 3.f,0.0f,0.0f,0.0f,0.001f,0.0f);

//		DM4310_test.Init(&hcan1, DM_Motor_ID_0xA1, DM_Motor_Control_Method_MIT_TORQUE, 0);
//        DM4310_test.Set_Target_Angle(3.0f);
        //c板陀螺仪spi外设
